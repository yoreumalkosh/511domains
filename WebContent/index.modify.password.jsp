...
<body>
	...
	<div class="modal" id="modalPasswordUpdateSuccessful">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-footer">
					<button type="button" id="passwordReload" class="btn btn-primary"
	...
	<script type="text/javascript"
		src="scriptsModifyPassword?<%=codeScripts%>"></script>
</body>
</html>