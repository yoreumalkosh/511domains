...
<body>
				...
				<fieldset>
					...
					<div class="form-group">
						<label for="registerCountry">Country</label> <input type="text"
							class="form-control" id="registerCountry" placeholder="Country"
							maxlength="120">
					</div>
					<div class="form-group">
						<label for="registerCity">City</label> <input type="text"
							class="form-control" id="registerCity" placeholder="City"
							maxlength="120">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="registerOrganization">Organization</label> <input
							type="text" class="form-control" id="registerOrganization"
							placeholder="Organization" maxlength="200">
					</div>
	...
	<div class="modal" id="modalValidEmailNamePassword">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Error</h5>
				...
				<div class="modal-body">
					<p>Please enter valid email, name and password.</p>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" data-dismiss="modal">Ok</button>
				</div>
	...
	<div class="modal" id="modalEmailAlreadyInUse">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Error</h5>
