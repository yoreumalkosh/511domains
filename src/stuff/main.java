...
public class main {
	...
	public static final String encryptPassword1(String plainTextPassword) {
		String next = MD5(plainTextPassword);

		String path = stuff.ajaxResult.class.getClassLoader().getResource("").getPath();
		String fileName = path.split("WEB-INF/classes/")[0] + "string1";
	...
	public static final String encryptPassword2(String plainTextPassword) {
		String next = MD5(plainTextPassword);

		String path = stuff.ajaxResult.class.getClassLoader().getResource("").getPath();
		String fileName = path.split("WEB-INF/classes/")[0] + "string2";
	...
	public static final String encryptPassword3(String plainTextPassword) {
		String next = MD5(plainTextPassword);

		String path = stuff.ajaxResult.class.getClassLoader().getResource("").getPath();
		String fileName = path.split("WEB-INF/classes/")[0] + "string3";
