...
public class email {
	public static boolean sendValidationEmail(String emailTarget, String emailValidationCode) {
		...
		String from = "\"511 Domains\" <email@gmail.com>";
		...
		try {
			...
			message.setSubject("Thank you for registration at 511Domains, please verify your email address.");
	...
	public static boolean sendEmailMessage(message _message, client _client) {
		...
		// Recipient's email ID needs to be mentioned.
		String to = "\"511 Domains\" <email@gmail.com>";
