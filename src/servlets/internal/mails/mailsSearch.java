 ...
 */
@WebServlet(main.internalServletsPrefix + "/mailsSearch")
public class mailsSearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (_dbDomain.getDomainName() != null) {
				_ajaxResult.insert(true, jsonPair, _mails.searchMails(_dbDomain, _client).retrieve().get("object"));	
			} else {
