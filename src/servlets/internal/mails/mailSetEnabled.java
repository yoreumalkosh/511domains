...
/**
 * Servlet implementation class accountEnable
 */
@WebServlet(main.internalServletsPrefix + "/mailToggle")
public class mailSetEnabled extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public mailSetEnabled() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			_ajaxResult.insert(true, jsonPair, _mails.setIsEnabledMail(_mail, _dbDomain, _client).retrieve().get("object"));
