 ...
 */
@WebServlet(main.internalServletsPrefix + "/mailDelete")
public class mailDelete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			_ajaxResult.insert(true, jsonPair, _mails.deleteMail(_mail, _dbDomain, _client).retrieve().get("object"));
