...
/**
 * Servlet implementation class domainModify
 */
@WebServlet(main.internalServletsPrefix + "/domainValidate")
public class domainValidate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public domainValidate() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			_domain.setDomainId((long)jsonObject.get("domainId"));
			
			_ajaxResult.insert(true, jsonPair, _domains.validateDomain(_domain).retrieve().get("object"));
