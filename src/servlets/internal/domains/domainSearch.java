...
/**
 * Servlet implementation class domainSearch
 */
@WebServlet(main.internalServletsPrefix + "/domainsSearch")
public class domainSearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			_ajaxResult.insert(true, jsonPair, _domains.searchDomains(_client).retrieve().get("object"));
