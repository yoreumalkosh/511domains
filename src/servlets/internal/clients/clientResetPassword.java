 ...
 */
@WebServlet(main.internalServletsPrefix + "/clientResetPassword")
public class clientResetPassword extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String passwordResetCode = stuff.main.generateEmailValidationCode();
			client _newClient = _clients.searchClientBeanByEmail(_client);
			_clients.createPasswordResetCode(passwordResetCode, _newClient);
			boolean booleanResult = stuff.email.sendPasswordResetEmail((String) jsonObject.get("email"), passwordResetCode);
