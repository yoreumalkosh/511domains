 ...
 */
@WebServlet(main.internalServletsPrefix + "/clientContact")
public class clientContact extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			_message.setClientId(_dbClient.getClientId());
			_message.setDateTimeCreated(now);
			_message.setMessageText((String)jsonObject.get("messageText"));
			_message.setSubject((String)jsonObject.get("messageSubject"));
			
			messages _messages = new messages();
			_messages.insertMessage(_message);
			
			boolean booleanResult = email.sendEmailMessage(_message, _dbClient);
