 ...
 */
@WebServlet(main.internalServletsPrefix + "/clientVerification")
public class clientVerification extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			boolean booleanResult = stuff.email.sendValidationEmail((String) jsonObject.get("email"), emailValidationCode);
