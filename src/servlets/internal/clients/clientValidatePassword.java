 ...
 */
@WebServlet(main.internalServletsPrefix + "/clientValidatePassword")
public class clientValidatePassword extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public clientValidatePassword() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String validationCode = (String)jsonObject.get("passwordResetCode");
			...
			_ajaxResult.insert(true, jsonPair, _clients.validatePasswordReset(validationCode, _client).retrieve().get("object"));
