 ...
 */
@WebServlet(main.internalServletsPrefix + "/clientValidateEmail")
public class clientValidateEmail extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public clientValidateEmail() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String emailChangeValidationCode = (String) jsonObject.get("validationCode");

			_ajaxResult.insert(true, jsonPair, _clients.validateEmailChange(emailChangeValidationCode).retrieve().get("object"));
