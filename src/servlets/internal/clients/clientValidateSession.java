 ...
 */
@WebServlet(main.internalServletsPrefix + "/clientValidateSession")
public class clientValidateSession extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public clientValidateSession() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			jsonObject.put("booleanResult", __validateSessionBean.isBooleanResult());
			jsonObject.put("clientId", __validateSessionBean.getClientId());
			
			_ajaxResult.insert(true, jsonPair, jsonObject);
